...
var events = map[string]release.HookEvent{
	...
	// Support example-success for backward compatibility with Helm 2 tests
	"example-success": release.HookTest,
}
...
//  metadata:
// 		annotations:
// 			agile-helm/hook-delete-policy: hook-succeeded
