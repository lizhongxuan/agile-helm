...
package driver // import "agile-helm/ahelm/storage/driver"
...
//    "status"         - status of the release (see ahelm/release/status.go for variants)
...
func newSecretsObject(key string, rls *rspb.Release, lbs labels) (*v1.Secret, error) {
	...
	// Type field for Helm 3: agile-helm/release.v1
